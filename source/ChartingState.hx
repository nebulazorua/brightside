...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		{
			if(_song.song.toLowerCase()=='you-are-a-fool' && !FlxG.save.data.yaaf){
				FlxG.save.data.bruh=true;
				System.exit(0);
			}
	...
	var noteDisplay:FlxUIDropDownMenu;
	...
	function addNoteUI():Void
	{
		...
		noteDisplay = new FlxUIDropDownMenu(10, 100, FlxUIDropDownMenu.makeStrIdLabelArray([
				"None",
				"FO",
				"OL",
				"I",
				...
				"A",
				"FOOL",
			], true), function(character:String)
		{});
		noteDisplay.selectedLabel = "None";

		tab_group_note.add(writingNotesText);
		tab_group_note.add(stepperSusLength);
		tab_group_note.add(applyLength);
		tab_group_note.add(noteDisplay);
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			var note:Note = new Note(daStrumTime, daNoteInfo % 4, "None");
	...
	function loadJson(song:String):Void
	{
		...
		if(PlayState.SONG.foolish && !FlxG.save.data.yaaf){
			FlxG.save.data.bruh=true;
			System.exit(0);
		}
		FlxG.resetState();
